...
app.get("/", function(req, res){
	Blog.find({}, function(err, foundItems){
		res.render("home", {homeContent: homeStartingContent, blogPosts: foundItems});
	});
...
app.get("/posts/:postId", function(req, res){
	...
	Blog.findOne({_id: requestedPostId}, function(err, foundItems){
		res.render("post", {newPostTitle: foundItems.name, newPostBody: foundItems.description});
	});
});
